...
public void test() throws IOException{
	...
	//	URL url17 = new URL("http://ceokarnataka.kar.nic.in/DraftRolls_2017/English/WOIMG/AC174/AC1740"+j+".pdf");
		URL url15 = new URL("http://ceokarnataka.kar.nic.in/FinalRoll_2015/Kannada/WOIMG/AC214/AC2140"+j+".pdf");
		URL url16 = new URL("http://ceokarnataka.kar.nic.in/FinalRoll_2016/Kannada/WOIMG/AC214/AC2140"+j+".pdf");
		URL urldraft17 = new URL("http://ceokarnataka.kar.nic.in/DraftRolls_2017/Kannada/WOIMG/AC214/AC2140"+j+".pdf");
		URL url17 = new URL("http://ceokarnataka.kar.nic.in/FinalRoll-2017/Kannada/WOIMG/AC214/AC2140"+j+".pdf");
	...
	try {
		            FileOutputStream fos = new FileOutputStream("NanjanGud.xls");
		            workbook.write(fos);
		            fos.close();
...
public static void main(String args[]) {
	...
	TestGundluPet tp = new TestGundluPet();
try{
	tp.test();
} catch(Exception e){
