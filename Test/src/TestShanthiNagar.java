...
public void test() throws IOException{
	...
	//	URL url17 = new URL("http://ceokarnataka.kar.nic.in/DraftRolls_2017/English/WOIMG/AC174/AC1740"+j+".pdf");
		/*URL url15 = new URL("http://ceokarnataka.kar.nic.in/FinalRoll_2015/English/WOIMG/AC163/AC1630"+j+".pdf");
		URL url16 = new URL("http://ceokarnataka.kar.nic.in/FinalRoll_2016/English/WOIMG/AC163/AC1630"+j+".pdf");
		URL urldraft17 = new URL("http://ceokarnataka.kar.nic.in/DraftRolls_2017/English/WOIMG/AC163/AC1630"+j+".pdf");
*/		URL url17 = new URL("http://ceokarnataka.kar.nic.in/FinalRoll-2017/Kannada/WOIMG/AC163/AC1630"+j+".pdf");
...
*/		              row.createCell(cellIndex++).setCellValue(booth17);
		              ...
		              System.out.println("Kannada final " +i  +"  "  + booth17);
	...
	try {
		            FileOutputStream fos = new FileOutputStream("ShanthiNagar.xls");
		            workbook.write(fos);
		            fos.close();
...
public static void main(String args[]) {
	...
	TestShanthiNagar tp = new TestShanthiNagar();
try{
	tp.test();
} catch(Exception e){
